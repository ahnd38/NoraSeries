...
public class BluetoothSerial {
	...
	public BluetoothSerial(Context context, BluetoothSerialListener listener) {
		...
		if(mHandlerThread != null && mHandlerThread.isAlive()){mHandlerThread.quitSafely();}
		mHandlerThread = new HandlerThread(this.getClass().getSimpleName() + "HandlerThread");
	...
	public boolean isConnected() {
		return (mService != null && mService.getState() == STATE_CONNECTED);
	}
