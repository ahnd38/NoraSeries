...
public interface GlobalTrustCommand
extends Cloneable,Comparable<GlobalTrustCommand>{

	public abstract GlobalTrustCommand clone();

	public abstract int compareTo(GlobalTrustCommand o);
