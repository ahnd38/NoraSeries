...
public class ReflectorLinkGet extends NoraVRPacketBase {
	...
	public ReflectorLinkGet() {
		super(NoraVRCommandType.RLINKGET);

		setClientCode(0x0);
	}

	@Override
	public ReflectorLinkGet clone() {
		ReflectorLinkGet copy = null;

		copy = (ReflectorLinkGet)super.clone();
