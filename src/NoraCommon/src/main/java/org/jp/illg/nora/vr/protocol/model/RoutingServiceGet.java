...
public class RoutingServiceGet extends NoraVRPacketBase {

	@Getter
	@Setter
	private long clientCode;

	public RoutingServiceGet() {
		super(NoraVRCommandType.RSRVGET);

		setClientCode(0x0);
	}

	@Override
	public RoutingServiceGet clone() {
		RoutingServiceGet copy = null;

		copy = (RoutingServiceGet)super.clone();
