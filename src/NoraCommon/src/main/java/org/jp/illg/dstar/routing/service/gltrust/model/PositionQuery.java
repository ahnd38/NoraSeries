...
@Slf4j
public class PositionQuery extends GlobalTrustCommandBase {
		...
		if(buffer.get() == (byte)0x80){
			...
			try {
				...
				if(log.isWarnEnabled())
					log.warn("Could not to convert unknown ip address...");
	...
	protected CommandType getCommandTypeInt() {
		return CommandType.PositionInformation;
	}
