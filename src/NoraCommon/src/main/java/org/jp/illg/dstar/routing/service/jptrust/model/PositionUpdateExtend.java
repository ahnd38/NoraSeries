...
public abstract class PositionUpdateExtend extends JpTrustCommandBase implements Cloneable {
...
//		super.getCommandID()[1] = (byte)0x5c;
		...
		super.setCommandType(CommandType.PositionUpdateExtend);
	}
